...
def generate_inventory_report(self):
    try:
        ...
        # Only select related supplier, no need for inventory
        products = Product.objects.select_related('supplier').all()

        inventory_data = []
        for product in products:
            quantity = product.quantity  # focus only on direct quantity field
        ...
        # Supplier performance: based on product.quantity instead of product.inventory.quantity
